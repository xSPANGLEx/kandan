  ...
  @displayNotification: (sender, message, channel_id,hash)->
	...
	# Change [hostname] and [port]
      ...
      notification.onclick = (event) ->
          window.focus()
          window.document.getElementById("ui-id-#{channel_id}").click();
          event.currentTarget.close()
